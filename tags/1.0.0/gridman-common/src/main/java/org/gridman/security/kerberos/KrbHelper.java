...
public class KrbHelper {
     ...
     * {@link org.gridman.security.kerberos.KrbHelper} ensureCurrentSubject() will be used.
     *
     ...
     * the specified {@link javax.security.auth.Subject}.<p/>
     *
     * @param ticket - the Kerberos session ticket to be validated
     * @param allowReplay - flag to indicate whether replay errors are ignored
     * @param subject - the {@link javax.security.auth.Subject} to use to validate the ticket.
     * @return a {@link KrbTicket} instance wrapping the validated ticket
     */
    ...
    /**
     * Extract the {@link javax.security.auth.kerberos.KerberosPrincipal} from the set of {@link java.security.Principal}
     * instances contained within the specified {@link javax.security.auth.Subject}.
     * </p>
     * If the {@link javax.security.auth.Subject} contains multiple {@link javax.security.auth.kerberos.KerberosPrincipal} instances
     * then the exact instance returned is undetermined.
     * If there are no {@link javax.security.auth.kerberos.KerberosPrincipal} instances contained within
     * the {@link javax.security.auth.Subject} this method will return null.
     * </p>
     * @param subject - the {@link javax.security.auth.Subject} to extract the {@link javax.security.auth.kerberos.KerberosPrincipal} from.
     * @return The {@link javax.security.auth.kerberos.KerberosPrincipal} contained within the specified {@link javax.security.auth.Subject}
     *         or null if there are no {@link javax.security.auth.kerberos.KerberosPrincipal} instances.
     */
    ...
    /**
     * An implementation of {@link java.security.PrivilegedExceptionAction} that obtains a
