...
public class NDRStream {
     ...
     * @throws IOException if an IO error occurs or if the string is malformed. A malformed string is
     ...
     * @throws IOException - BufferUnderflowException - If there are fewer than the toByteArray length bytes
