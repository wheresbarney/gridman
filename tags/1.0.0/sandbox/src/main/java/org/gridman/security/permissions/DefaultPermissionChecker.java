...
/**
 * An implementation of a {@link PermissionChecker} that can verify a
 * Subject qualifies for a given {@link Permission}.
 * <p/>
...
public class DefaultPermissionChecker implements PermissionChecker {
    ...
    /**
     * Returns the list of qualifiers that can imply qualification of a {@link Subject} for
     * the requested {@link Permission}.
     *
     * @param requestedPermission - the permission being requested
    ...
    /**
     * Returns the Set of qualifiers that qualify a {@link Subject} for
     * the requested {@link Permission}.
     *
     * @param requestedPermission - the permission being requested
     * @return the set of PermissionQualifiers that may qualify a Subject for a Permission
