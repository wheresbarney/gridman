 ...
 */
public class ActiveDirectoryState extends AbstractKerberosState {
    private static final Logger LOG = LoggerFactory.getLogger(ActiveDirectoryState.class);
     ...
     */
    protected ActiveDirectoryState(KdcServerContext context) {
        super(context);
    }
    ...
    public void test(TestClass testClass, Statement statement, RunNotifier notifier, InheritableKdcServerSettings settings) {
        ...
        ActiveDirectoryServerContext context = (ActiveDirectoryServerContext) getContext();
