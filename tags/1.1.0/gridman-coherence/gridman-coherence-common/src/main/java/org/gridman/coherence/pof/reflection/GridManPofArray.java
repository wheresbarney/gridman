 ...
 */
public class GridManPofArray extends PofArray implements GridManPofValue, GridManPofUniformValue {

    private ReadBuffer updatedBinary;

    public GridManPofArray(PofValue valueParent, ReadBuffer bufValue, PofContext ctx, int of, int nType, int ofChildren, int cElements) {
