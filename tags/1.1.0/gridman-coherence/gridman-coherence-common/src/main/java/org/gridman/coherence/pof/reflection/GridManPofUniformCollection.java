 ...
 */
public class GridManPofUniformCollection extends PofUniformCollection implements GridManPofValue, GridManPofUniformValue{

    private ReadBuffer updatedBinary;

    public GridManPofUniformCollection(PofValue valueParent, ReadBuffer bufValue, PofContext ctx, int of, int nType, int ofChildren, int cElements, int nElementType) {
        super(valueParent, bufValue, ctx, of, nType, ofChildren, cElements, nElementType);
    }
