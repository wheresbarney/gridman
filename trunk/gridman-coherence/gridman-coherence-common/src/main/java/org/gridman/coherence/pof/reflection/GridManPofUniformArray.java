 ...
 */
public class GridManPofUniformArray extends PofUniformArray implements GridManPofValue, GridManPofUniformValue {

    private ReadBuffer updatedBinary;

    public GridManPofUniformArray(PofValue valueParent, ReadBuffer bufValue, PofContext ctx, int of, int nType, int ofChildren, int cElements, int nElementType) {
