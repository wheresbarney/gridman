 ...
 */
public class GridManPofCollection extends PofCollection implements GridManPofValue {

    private ReadBuffer updatedBinary;

    public GridManPofCollection(PofValue valueParent, ReadBuffer bufValue, PofContext ctx, int of, int nType, int ofChildren, int cElements) {
